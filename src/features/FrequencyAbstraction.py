...
class FourierTransformation:
    ...
    def abstract_frequency(self, data_table, cols, window_size, sampling_rate):
        ...
        for i in range(
            ...
            step_size,  # changed that i added the last window to step by window size/2
        ):  # We can also use overlapping windows here, but for simplicity we use non-overlapping windows in this implementation.
            for col in cols:
