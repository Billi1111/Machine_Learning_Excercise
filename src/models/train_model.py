...
try:
    ...
    script_dir = r"C:\Users\Bilal's Desktop\Desktop\Machine learning Excersise\data-science-template\src\models"
...
df = pd.read_pickle(os.path.join(base_dir, "data", "interim", "03_data_features.pkl"))
...
df_train["label"].value_counts().plot(
    kind="bar", ax=ax, color="lightblue", label="Total", edgecolor="black"
)

y_train.value_counts().plot(
    kind="bar", ax=ax, color="dodgerblue", label="Train", edgecolor="black"
)
y_test.value_counts().plot(
    kind="bar", ax=ax, color="royalblue", label="Test", edgecolor="black"
)
plt.legend()
plt.show()
# --------------------------------------------------------------
...
max_features = 10
selected_features, ordered_features, feature_scores = learner.forward_selection(
...
plt.plot(np.arange(1, max_features + 1, 1), feature_scores)
